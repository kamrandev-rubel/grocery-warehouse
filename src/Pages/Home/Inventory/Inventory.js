                        ...
                        <div key={product._id} className='border-2 border-primary-color shadow-lg rounded-2xl p-3 bg-white'>
                            ...
                            <div className='flex justify-between px-3'>
                                ...
                                <div>
                                    ...
                                    <p className='font-bold text-sm text-gray-700 text-center'>{product?.quantity}</p>
                                </div>
                            </div>
                            ...
                            <div className='flex justify-center mt-3 mb-2'>
                                <Link to={`/updateinventory/${product?._id}`} className='font-[roboto] text-md text-gray-900 font-bold bg-primary-color px-8 py-2 rounded-md'>UPDATE</Link>
                            </div>
                        </div>
                    ))
                }
